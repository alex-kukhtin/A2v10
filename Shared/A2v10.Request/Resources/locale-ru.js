...
(function () {
	...
	const locale = {
		...
		$EmailNotConfirmed: 'Ваш e-mail не подтвержден.\nПроверьте почту через несколько минут',
		...
		$ConfirmReset: 'На адрес {0} была отправлен код для восстановления пароля.',
		$ConfirmRegister: 'На адрес {0} была отправлен код для подтверждения е-mail.',
