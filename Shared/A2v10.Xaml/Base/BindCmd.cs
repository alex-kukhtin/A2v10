...
public class BindCmd : BindBase
{
	...
	String GetOptions(RenderContext _1/*context*/)
	{
	...
	String GetOptionsForFile(RenderContext _1/*context*/)
	{
	...
	String GetOptionsValid(RenderContext _1/*context*/)
	{
	...
	Boolean IsArgumentEmpty(RenderContext _1/*context*/)
	{
		var argBind = GetBinding(nameof(Argument));
