namespace ChakraHost.Hosting
{
	...
	public struct JavaScriptSourceContext : IEquatable<JavaScriptSourceContext>
	{
		...
		public static Boolean operator ==(JavaScriptSourceContext left, JavaScriptSourceContext right)
		{
		...
		public static JavaScriptSourceContext operator -(JavaScriptSourceContext context, Int32 offset)
		{
		...
		/// <returns>A new source context that reflects the subtraction of the offset from the context.</returns>
		public static JavaScriptSourceContext Subtract(JavaScriptSourceContext left, Int32 right)
		{
			return left - right;
		}
		...
		/// <returns>A new source context that reflects the addition of the offset to the context.</returns>
		public static JavaScriptSourceContext Add(JavaScriptSourceContext left, Int32 right)
		{
			return left + right;
		}
		...
		/// <returns>Whether the two source contexts are the same.</returns>
		public Boolean Equals(JavaScriptSourceContext other)
		{
