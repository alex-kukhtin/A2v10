...
{
	private readonly IDictionary<ProfileAction, ProfileItems> _items = new Dictionary<ProfileAction, ProfileItems>();
...
public sealed class WebProfiler : IProfiler, IDataProfiler, IDisposable
{
	...
	void AddRequestToSession(ProfileRequest action)
	{
		...
		if (currentContext == null)
			return;
		if (currentContext.Session[_sessionKey] is not LinkedList<ProfileRequest> sessionArray)
		{
