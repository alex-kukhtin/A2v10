...
public:
	static void Init();
	static bool LoadResource(const char* url, std::string& mime, std::string& contentDisposition, std::vector<byte>& data, std::vector<byte>& post, bool postMethod, int& status_code);
